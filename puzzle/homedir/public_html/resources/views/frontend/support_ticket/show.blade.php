                                ...
                                <div class="border-bottom pb-4">
                                    <form class="" action="{{route('support_ticket.seller_store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control editor" name="reply" placeholder="{{__('type product description')}}" data-buttons="bold,underline,italic,|,ul,ol,|,paragraph,|,undo,redo"></textarea>
                                        </div>
                                        <div class="form-group">
