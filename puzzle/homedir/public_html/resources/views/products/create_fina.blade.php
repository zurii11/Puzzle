							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<select class="form-control demo-select2-placeholder" name="fina_category" required>
										@foreach($groups->groups as $groupslist)
											<option value="{{$groupslist->id}}">{{__($groupslist->name)}}</option>
										@endforeach
									</select>
								</div>
							</div>
							...
							<div class="form-group" id="category">
								...
								<div class="col-lg-7">
									<select class="form-control demo-select2-placeholder" name="unit" required>
										@foreach($units->units as $unitslist)
											<option value="{{$unitslist->id}}">{{__($unitslist->full_name)}}</option>
										@endforeach
									</select>
								</div>
							</div>
