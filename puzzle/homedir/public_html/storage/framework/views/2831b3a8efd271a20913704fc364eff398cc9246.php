				...
				<div class="tab-base tab-stacked-left">
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label"><?php echo e(__('Product Code')); ?></label>
								<div class="col-lg-7">
									<input type="text" class="form-control" name="productcode" placeholder="<?php echo e(__('Product Code')); ?>">
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-lg-2 control-label"><?php echo e(__('ფინა კატეგორია')); ?></label>
								<div class="col-lg-7">
									<select class="form-control demo-select2-placeholder" name="fina_category" >
									</select>
								</div>
							</div>
							<div class="form-group" id="brand">
								...
								<label class="col-lg-1 control-label">+<?php echo e(__('Brand')); ?></label>
								<div class="col-lg-3"> 	
									<input type="text" class="form-control" name="brand" placeholder="<?php echo e(__('New Brand')); ?>">
								</div>
							</div>
							<div class="form-group" id="category">
								...
								<div class="col-lg-7">
									<select class="form-control demo-select2-placeholder" name="unit" required>
											...
											<option value="10">ყუთი</option>
											<option value="11">ქილა</option>
											<option value="12">ბოთლი</option>
											<option value="13">კილომეტრი</option>
											<option value="14">კვადრატული სანტიმეტრი</option>
											<option value="15">კუბური მეტრი</option>
											<option value="16">მილილიტრი</option>
											<option value="17">სხვა</option>
											<option value="18">ჭიქა</option>
											<option value="19">შეკვრა</option>
											<option value="2">კილოგრამი</option>
											<option value="3">მეტრი</option>
											<option value="4">ლიტრი</option>
											<option value="5">გრამი</option>
											<option value="6">ტონა</option>
											<option value="7">წყვილი (2 ცალი)</option>
											<option value="8">სანტიმეტრი</option>
											<option value="9">კვადრატული მეტრი</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="tags[]" placeholder="<?php echo e(__('Tags')); ?>" data-role="tagsinput">
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label"><?php echo e(__('Barcode')); ?></label>
								<div class="col-lg-7">
									<input type="text" class="form-control" name="barcode" placeholder="<?php echo e(__('Barcode')); ?>" required>
								</div>
							</div>
				        </div>
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label"><?php echo e(__('Status 1 price')); ?></label>
								<div class="col-lg-7">
									<input type="number" min="0" value="0" step="0.01" placeholder="<?php echo e(__('Status 1 price')); ?>" name="unit_price_s1" class="form-control">
								</div>
								<div class="col-lg-1">
									<select class="demo-select2" name="unit_price_s1_type">
										<option value="amount">ლ</option>
										<option value="percent">%</option>
									</select>
								</div>
							</div> 
							<div class="form-group">
								<label class="col-lg-2 control-label"><?php echo e(__('Status 2 price')); ?></label>
								<div class="col-lg-7">
									<input type="number" min="0" value="0" step="0.01" placeholder="<?php echo e(__('Status 2 price')); ?>" name="unit_price_s2" class="form-control">
								</div>
								<div class="col-lg-1">
									<select class="demo-select2" name="unit_price_s2_type">
										<option value="amount">ლ</option>
										<option value="percent">%</option>
									</select>
								</div>
...
<script type="text/javascript">
	...
	function get_brands_by_subcategory(){
		var subcategory_id = $('#subcategory_id').val();
		$.post('<?php echo e(route('subcategories.get_brands_by_subcategory')); ?>',{_token:'<?php echo e(csrf_token()); ?>', subcategory_id:subcategory_id}, function(data){
		    $('#brand_id').html(null);
		    for (var i = 0; i < data.length; i++) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/solage/public_html/puzzle.sola.ge/resources/views/products/create.blade.php ENDPATH**/ ?>