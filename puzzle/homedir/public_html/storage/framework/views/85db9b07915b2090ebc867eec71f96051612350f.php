    ...
    <div class="product-box">
        <div class="block">
            <div class="block-image">
                <img loading="lazy"  src="<?php echo e(asset($product->thumbnail_img)); ?>" class="" alt="Product Image">
            </div>
...
<?php /**PATH /home/solage/public_html/puzzle.sola.ge/resources/views/frontend/partials/addedToCart.blade.php ENDPATH**/ ?>