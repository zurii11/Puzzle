				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<select class="form-control demo-select2-placeholder" name="fina_category" required>
										<?php $__currentLoopData = $groups->groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupslist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($groupslist->id); ?>"><?php echo e(__($groupslist->name)); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</div>
							</div>
								...
								<div class="col-lg-7">
									<select class="form-control demo-select2-placeholder" name="unit" required>
										<?php $__currentLoopData = $units->units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unitslist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($unitslist->id); ?>"><?php echo e(__($unitslist->full_name)); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</div>
							</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/puzzlege/public_html/resources/views/products/create.blade.php ENDPATH**/ ?>