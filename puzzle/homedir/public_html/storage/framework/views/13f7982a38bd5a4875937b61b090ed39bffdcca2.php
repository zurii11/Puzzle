        ...
        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(__('Bannerhover')); ?></th>
            ...
            <tbody>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><img loading="lazy"  class="img-md" src="<?php echo e(asset($category->banner)); ?>" alt="<?php echo e(__('banner')); ?>"></td>
                        <td><img loading="lazy"  class="img-md" src="<?php echo e(asset($category->bannerhover)); ?>" alt="<?php echo e(__('bannerhover')); ?>"></td>
                        <td><img loading="lazy"  class="img-xs" src="<?php echo e(asset($category->icon)); ?>" alt="<?php echo e(__('icon')); ?>"></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/solage/public_html/puzzle.sola.ge/resources/views/categories/index.blade.php ENDPATH**/ ?>