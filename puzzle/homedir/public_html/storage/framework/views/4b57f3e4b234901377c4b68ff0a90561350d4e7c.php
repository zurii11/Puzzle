				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="productcode" placeholder="<?php echo e(__('Product Code')); ?>" value="<?php echo e($product->productcode); ?>">
								</div>
							</div>
	                        ...
	                        <div class="form-group" id="brand">
								...
								<div class="col-lg-3"> 	
									<input type="text" class="form-control" name="brand" placeholder="<?php echo e(__('New Brand')); ?>" value="<?php echo e($product->brand); ?>">
								</div>
	                        </div>
							<div class="form-group" id="category">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="barcode" placeholder="barcode" value="<?php echo e($product->barcode); ?>" required>
	                            </div>
	                        </div>
							<input type="hidden" class="form-control" name="finaid" placeholder="finaid" value="<?php echo e($product->finaid); ?>" required>
				        </div>
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							...
							<div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="text" placeholder="<?php echo e(__('Status 1 price')); ?>" name="unit_price_s1" class="form-control" value="<?php echo e($product->unit_price_s1); ?>">
	                            </div>
	                            <div class="col-lg-1">
							...
							<div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="text" placeholder="<?php echo e(__('Status 2 price')); ?>" name="unit_price_s2" class="form-control" value="<?php echo e($product->unit_price_s2); ?>">
	                            </div>
	                            <div class="col-lg-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/solage/public_html/puzzle.sola.ge/resources/views/products/edit.blade.php ENDPATH**/ ?>