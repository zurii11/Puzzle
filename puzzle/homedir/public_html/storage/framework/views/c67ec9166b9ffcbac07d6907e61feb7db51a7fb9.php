                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge--2 mr-4">
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if($order->payment_status_viewed == 0): ?><span class="ml-2" style="color:green"><strong>(<?php echo e(__('Updated')); ?>)</strong></span><?php endif; ?>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/puzzle/public_html/resources/views/frontend/purchase_history.blade.php ENDPATH**/ ?>