...
<?php $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<?php if(strlen($str) > 0): ?>
		<tr>
			...
			<td>
				<input type="text" name="sku_<?php echo e($str); ?>" value="<?php echo e($str); ?>" class="form-control" required>
			</td>
			<td>
...
<?php endif; ?>
<?php /**PATH /home/solage/public_html/puzzle.sola.ge/resources/views/partials/sku_combinations_edit.blade.php ENDPATH**/ ?>