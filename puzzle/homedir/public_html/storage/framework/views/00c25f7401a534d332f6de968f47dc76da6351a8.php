				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<select class="form-control demo-select2-placeholder" name="fina_category" id="fina_category" required>
										<?php $__currentLoopData = $groups->groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupslist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<option value="<?php echo e($groupslist->id); ?>" <?php if($groupslist->id == $product->finacategory_id) { echo 'selected'; } ?> ><?php echo e(__($groupslist->name)); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group" id="category">
								...
								<div class="col-lg-7">
									<select class="form-control demo-select2-placeholder" name="unit" required>
										<?php $__currentLoopData = $units->units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unitslist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
											<option value="<?php echo e($unitslist->id); ?>" <?php if($unitslist->id == $product->finaunit_id) { echo 'selected'; } ?>><?php echo e(__($unitslist->full_name)); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</select>
								</div>
							</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/puzzlege/public_html/resources/views/products/edit.blade.php ENDPATH**/ ?>