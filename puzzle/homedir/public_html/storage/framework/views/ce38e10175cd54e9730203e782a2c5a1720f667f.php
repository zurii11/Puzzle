...
<?php $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<?php if(strlen($str) > 0): ?>
			<tr>
				...
				<td>
					<input type="number" name="qty_<?php echo e($str); ?>" value="10" min="0" step="1" class="form-control" required>
				</td>
			</tr>
	<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/solage/public_html/puzzle.sola.ge/resources/views/partials/sku_combinations.blade.php ENDPATH**/ ?>