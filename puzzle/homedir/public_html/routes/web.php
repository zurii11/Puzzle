...
Route::post('/subcategories/get_brands_by_subcategory', 'SubCategoryController@get_brands_by_subcategory')->name('subcategories.get_brands_by_subcategory');

Route::get('/contact', 'HomeController@contact')->name('contact');
Route::get('/', 'HomeController@index')->name('home');
Route::get('/subcategory/{category_slug}', 'HomeController@subcategory')->name('subcategory');
...
//Bank Of Georgia START
Route::get('/ControllerPaymentBog', 'ControllerPaymentBog@index')->name('ControllerPaymentBog');
Route::get('/ControllerPaymentBog/CheckPaymentAvail', 'ControllerPaymentBog@CheckPaymentAvail')->name('ControllerPaymentBog');
Route::get('/ControllerPaymentBog/registerPayment', 'ControllerPaymentBog@registerPayment')->name('ControllerPaymentBog');
//Route::get('/paypal/payment/cancel', 'PaypalController@getCancel')->name('payment.cancel');
//Bank Of Georgia  END
...
Route::group(['middleware' => ['user', 'verified']], function(){
	...
	Route::get('/cardpayment', 'HomeController@dashboard')->name('dashboard');
	...
	Route::get('/specialoders','SupportTicketController@index')->name('specialoders');
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::post('/orders/orderinfina', 'OrderController@orderinfina')->name('orders.orderinfina');
