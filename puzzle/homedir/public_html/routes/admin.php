...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/products/finatest','ProductController@finatest')->name('products.finatest');
	...
	Route::get('/customers/statuszero/{id}', 'CustomerController@statuszero')->name('customers.statuszero');
	Route::get('/customers/statustwo/{id}', 'CustomerController@statustwo')->name('customers.statustwo');
	Route::get('/customers/statusthree/{id}', 'CustomerController@statusthree')->name('customers.statusthree');
	...
	Route::get('/stock_report_fina', 'ReportController@stock_report_fina')->name('stock_report_fina.index');
