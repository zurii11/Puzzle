        ...
        <div class="card-title">
            <div class="row align-items-center">
                ...
                <div class="col-6 text-right">
                    <span class="badge badge-md badge-success">{{ count(App\Carts::where('user_id', Auth::user()->id)->get()) }} {{__('Items')}}</span>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <table class="table-cart table-cart-review">
                ...
                <tfoot>
                    ...
                    @endif Currently not using any coupons or discounts -->
        ...
        <div class="card-body">
            ...
            <table class="table-cart table-cart-review">
                ...
                <tfoot>
                    ...
                    @endif for the 3rd time, we are not using ANY coupons -->
