				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="productcode" placeholder="{{__('Product Code')}}">
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('ფინა კატეგორია')}}</label>
								<div class="col-lg-7">
							...
							<div class="form-group" id="brand">
								...
								<div class="col-lg-3"> 	
									<input type="text" class="form-control" name="brand" placeholder="{{__('New Brand')}}">
								</div>
							</div>
							<div class="form-group" id="category">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="tags[]" placeholder="{{__('Tags')}}" data-role="tagsinput">
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Barcode')}}</label>
								<div class="col-lg-7">
									<input type="text" class="form-control" name="barcode" placeholder="{{__('Barcode')}}" required>
								</div>
							</div>
				        </div>
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="0" step="0.01" placeholder="{{__('Status 1 price')}}" name="unit_price_s1" class="form-control">
								</div>
								<div class="col-lg-1">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="0" step="0.01" placeholder="{{__('Status 2 price')}}" name="unit_price_s2" class="form-control">
								</div>
								<div class="col-lg-1">
