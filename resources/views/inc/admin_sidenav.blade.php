                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li class="{{ areActiveRoutes(['orders.index.admin', 'orders.show'])}}">
                            <a class="nav-link" href="{{ route('orders.index.admin') }}">
                                ...
                                <span class="menu-title">{{__('Inhouse orders')}} @if($orderspending > 0)<span class="pull-right badge badge-info">{{ $orderspending }}</span>@endif</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a class="nav-link" href="{{ route('customers.index') }}">
                                <i class="fa fa-user-plus"></i>
                                <span class="menu-title">{{__('Customers')}} @if($usercount > 0)<span class="pull-right badge badge-info">{{ $usercount }}</span>@endif</span>
                            </a> 
                        </li>
                        @endif
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['stock_report_fina.index'])}}">
                                    <a class="nav-link" href="{{ route('stock_report_fina.index') }}">ფინა - შესყიდვის სია</a>
                                </li>
