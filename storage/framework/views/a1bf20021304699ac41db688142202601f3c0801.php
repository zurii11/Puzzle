            ...
            <ul class="nav navbar-top-links">
                ...
                <li class="dropdown" id="lang-change">
                    ...
                    <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                        <img loading="lazy"  src="<?php echo e(asset('frontend/images/icons/flags/'.$locale.'.png')); ?>" class="flag" style="margin-right:6px;"><span class="language"><?php echo e(\App\Language::where('code', $locale)->first()->name); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <?php $__currentLoopData = \App\Language::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="dropdown-item <?php if($locale == $language): ?> active <?php endif; ?>">
                                <a href="#" data-flag="<?php echo e($language->code); ?>"><img loading="lazy"  src="<?php echo e(asset('frontend/images/icons/flags/'.$language->code.'.png')); ?>" class="flag" style="margin-right:6px;"><span class="language"><?php echo e($language->name); ?></span></a>
                            </li>
...
<?php /**PATH C:\xampp\htdocs\puzzle\homedir\public_html\resources\views/inc/admin_nav.blade.php ENDPATH**/ ?>