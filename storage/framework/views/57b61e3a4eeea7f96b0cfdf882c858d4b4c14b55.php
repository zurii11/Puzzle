                    ...
                    <form class="form-horizontal" action="<?php echo e(route('top_10_settings.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-3" for="url"><?php echo e(__('Top Categories (Max 10)')); ?></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3" for="url"><?php echo e(__('Top Brands (Max 10)')); ?></label>
                                <div class="col-sm-9">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/solage/public_html/puzzle.sola.ge/resources/views/home_settings/index.blade.php ENDPATH**/ ?>