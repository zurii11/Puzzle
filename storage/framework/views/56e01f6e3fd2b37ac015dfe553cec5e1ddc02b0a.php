        ...
        <div class="card-title">
            <div class="row align-items-center">
                ...
                <div class="col-6 text-right">
                    <span class="badge badge-md badge-success"><?php echo e(count(App\Carts::where('user_id', Auth::user()->id)->get())); ?> <?php echo e(__('Items')); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <table class="table-cart table-cart-review">
                ...
                <tbody>
                    <?php
                        ...
                        $tax = 0;
                        $shipping = 0;
                        $cart = App\Carts::where('user_id', Auth::user()->id)->get();
                    ?>
            ...
            <table class="table-cart table-cart-review">
                ...
                <tfoot>
                    ...
                    <?php endif; ?> Currently not using any coupons or discounts -->
        ...
        <div class="card-body">
            ...
            <table class="table-cart table-cart-review">
                ...
                <tfoot>
                    ...
                    <?php endif; ?> for the 3rd time, we are not using ANY coupons -->
            ...
            <!-- <?php if(Auth::check() && \App\BusinessSetting::where('type', 'coupon_system')->first()->value == 1): ?>
                ...
                <?php endif; ?>
            <?php endif; ?> NO FCKING COUPONS -->
        </div>
    </div>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Puzzle\resources\views/frontend/partials/cart_summary.blade.php ENDPATH**/ ?>