<a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <?php if(Auth::check()): ?>
        <span class="nav-box-number"><?php echo e(count(App\Carts::where('user_id', Auth::user()->id)->get())); ?></span>
    <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\Puzzle\resources\views/frontend/partials/cart.blade.php ENDPATH**/ ?>