                    ...
                    <ul id="mainnav-menu" class="list-group">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="<?php echo e(areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit'])); ?>">
                                        <a class="nav-link" href="<?php echo e(route('products.admin')); ?>"><?php echo e(__('Products')); ?></a>
                                    </li>
                        ...
                        <li class="<?php echo e(areActiveRoutes(['orders.index.admin', 'orders.show'])); ?>">
                            <a class="nav-link" href="<?php echo e(route('orders.index.admin')); ?>">
                                ...
                                <span class="menu-title"><?php echo e(__('Inhouse orders')); ?> <?php if($orderspending > 0): ?><span class="pull-right badge badge-info"><?php echo e($orderspending); ?></span><?php endif; ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class="<?php echo e(areActiveRoutes(['sellers.index', 'sellers.create', 'sellers.edit', 'sellers.payment_history'])); ?>">
                                    <?php
                        ...
                        <li>
                            <a class="nav-link" href="<?php echo e(route('customers.index')); ?>">
                                <i class="fa fa-user-plus"></i>
                                <span class="menu-title"><?php echo e(__('Customers')); ?> <?php if($usercount > 0): ?><span class="pull-right badge badge-info"><?php echo e($usercount); ?></span><?php endif; ?></span>
                            </a> 
                        </li>
                        <?php endif; ?>
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class="<?php echo e(areActiveRoutes(['stock_report_fina.index'])); ?>">
                                    <a class="nav-link" href="<?php echo e(route('stock_report_fina.index')); ?>">ფინა - შესყიდვის სია</a>
                                </li>
...
<?php /**PATH C:\xampp\htdocs\puzzle\homedir\public_html\resources\views/inc/admin_sidenav.blade.php ENDPATH**/ ?>