                                ...
                                <?php for($i = 0; $i < 11; $i++): ?>
                                    <li class="<?php if($i == 0) echo 'active' ?>">
                                        <a href="#<?php echo e($i); ?>" class="row no-gutters align-items-center">
                                            <div class="col-md-3">
                                                <img loading="lazy"  class="cat-image" src="<?php echo e(asset($categories[$i]->icon)); ?>">
                                            </div>
                                            <div class="col-md-9">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="<?php if($key == 0) echo 'active' ?>">
                                        <a href="#<?php echo e($key); ?>" class="row no-gutters align-items-center">
                                            <div class="col-md-3">
                                                <img loading="lazy"  class="cat-image" src="<?php echo e(asset($category->icon)); ?>">
                                            </div>
                                            <div class="col-md-9">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(count($categories)>12 && $key == 11): ?>
                                <div class="sub-category-menu active" id="more">
                                    <h3 class="category-name"><a href="<?php echo e(route('products.category', $category->slug)); ?>"><?php echo e(__($category->name)); ?></a></h3>
                                    <ul>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/solage/public_html/puzzle.sola.ge/resources/views/frontend/all_category.blade.php ENDPATH**/ ?>