...
<body>
    ...
    <div id="container" class="blank-index"
        <?php if($generalsetting->admin_login_background != null): ?>
            style="background-image:url('<?php echo e(asset($generalsetting->admin_login_background)); ?>');"
        <?php else: ?>
            style="background-image:url('<?php echo e(asset('img/bg-img/login-bg.jpg')); ?>');"
        <?php endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\puzzle\homedir\public_html\resources\views/layouts/login.blade.php ENDPATH**/ ?>