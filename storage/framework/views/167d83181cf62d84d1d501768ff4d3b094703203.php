...
<?php $__env->startSection('content'); ?>
    ...
    <div class="pad-all text-center">
        <form class="" action="<?php echo e(route('in_house_sale_report.index')); ?>" method="GET">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($product->num_of_sale); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/puzzlege/public_html/resources/views/reports/in_house_sale_report.blade.php ENDPATH**/ ?>