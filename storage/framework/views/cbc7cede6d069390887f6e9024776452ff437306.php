                    ...
                    <?php if($order != null): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <?php echo e(__(ucfirst(str_replace('_', ' ', $status)))); ?>

                            </td>
                            <td>
                                <?php echo e(__(ucfirst(str_replace('_', ' ', $order->payment_type)))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/solage/public_html/puzzle.sola.ge/resources/views/orders/index.blade.php ENDPATH**/ ?>