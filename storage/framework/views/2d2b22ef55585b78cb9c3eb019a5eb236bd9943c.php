                                        ...
                                        <tr class="cart-item">
                                            ...
                                            <td class="product-quantity d-none d-md-table-cell">
                                                <div class="input-group input-group--style-2 pr-4" style="width: 130px;">
                                                    ...
                                                    <input type="text" name="quantity[<?php echo e($key); ?>]" class="form-control input-number" placeholder="1" value="<?php echo e($quantity); ?>" min="1" max="10" onchange="updateQuantity(<?php echo e($key); ?>, this)">
                                                    <span class="input-group-btn">
...
<?php /**PATH C:\xampp\htdocs\Puzzle\resources\views/frontend/partials/cart_details.blade.php ENDPATH**/ ?>