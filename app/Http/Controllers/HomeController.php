...
class HomeController extends Controller
{
    ...
    public function subcategory($category_slug)
    {
        ...
        return view('frontend.subcategory', compact('category_slug'));
    }
    ...
    {
        $keywords = array();
        $products = Product::where('published', 1)->where('tags', 'like', '%'.$request->search.'%')->orwhere('productcode', 'like', '%'.$request->search.'%')->get();
    ...
    public function search(Request $request)
    {
        ...
        if($query != null){
            ...
            $products = $products->where('name', 'like', '%'.$query.'%')->orwhere('productcode', 'like', '%'.$query.'%');
        }
    ...
    public function variant_price(Request $request)
    {
        ...
        if($str != null){
            ...
            $quantity = 5000;//$product->current_stock;
        }
